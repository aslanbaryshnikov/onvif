...
module.exports = function(Cam) {
   ...
   * @property {number} focus.farLimit
	...
	/**
	 * Request the focus lens move options to be used in the move command
	 * @param {object} [options]
	 * @param {Object} options.token videoSourceToken
	 * @param {function} [callback]
	 */
	Cam.prototype.getImagingMoveOptions = function(options, callback) {
		if (typeof callback === 'undefined') {
			callback = options;
			options = {};
		}
	...
	/**
	 * Request the current imaging status from the device
	 * @param {object} [options]
	 * @param {Object} options.token videoSourceToken
	 * @param {function} [callback]
	 */
	Cam.prototype.getImagingStatus = function(options, callback) {
		if (typeof callback === 'undefined') {
			callback = options;
			options = {};
		}
